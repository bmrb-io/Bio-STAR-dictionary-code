...
Sub read_star(tag_list, tag_ct, tag_char, table_list, table_ct, sf_list, sf_ct, pathin, input_file, run_option, tag_desc)
...
ReDim loop_text_value(100, 100) As String
Dim tag_use(1500)
...
While EndDoc = 0
    ...
    'store the data tags in the current loop
                If loop_flag = 1 Then
                    If loop_item_ct = 0 Then
                        ReDim loop_text_value(1 To 100, 1 To 100) As String
                        ReDim loop_value(500) As String
    ...
    'Application specific code
        ...
        'If run_option = 13 Then
        '    update_interface data_tag_flag, tag_pair, tag_ct, tag_list, tag_char
        'End If
