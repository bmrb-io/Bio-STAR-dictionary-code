...
' write_dict.bas
Sub write_dictionary(NMR_STAR_dict_path, dictionary_filename, new_table)
...
tag_print_count = 0
Open NMR_STAR_dict_path + dictionary_filename For Output As 1
